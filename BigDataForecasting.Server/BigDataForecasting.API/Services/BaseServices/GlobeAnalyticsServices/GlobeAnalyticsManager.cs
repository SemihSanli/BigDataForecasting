...
namespace BigDataForecasting.API.Services.BaseServices.GlobeAnalyticsServices
{
    public class GlobeAnalyticsManager : IGlobeAnalyticsService
    {
        ...
        public GlobeAnalyticsManager(ICustomerService customerService, IRedisCachingService redisCachingService)
        {
        ...
        {
            return await _redisCachingService.GetOrAddAsync(GlobeKeys.Nodes, async () =>
            {
